...
class HetMol():
    """This class contains the information about the 'HetMol' object (packman.molecule.HetMol).

    Hetmol is a small molecule counterpart of the 'Residue' in the molecule hierarchy.

    This class contains all the information available about the HetMol and stores the corresponding 'Atom' objects in itself. The HetMol class is the second lowest in the hierarchy of the 'molecule' API classes.
    ...
    Args:
        id (str): HetMol ID from the PDB file as it is. Each HetMol in a PDB file Model/Frame has unique ID. (essential)
        name (str): HetMol Name from the PDB file as it is.
        parent (packman.molecule.Chain): The Chain Object (parent) this HetMol belongs to.
    ...
    def __setitem__(self,id: int, Atom: 'Atom'):
        ...
        Args:
            ...
            Atom  (ref:`packman.molecule.Atom`) : The new 'Atom' to be assigned to the 'HetMol'
        """
        try:
    ...
    def get_parent(self) -> 'Chain':
        ...
        Returns:
            ref:`packman.molecule.Chain` if successful, None otherwise.
        """
    ...
    def set_parent(self, new_parent: 'Chain'):
        ...
        Args:
            new_parent (ref:`packman.molecule.Chain`): The parent 'Chain' User wishes to assign to the given 'HetMol'
        """
        self.__parent = new_parent
    
    def get_atom(self, key: Union[int, str]):
